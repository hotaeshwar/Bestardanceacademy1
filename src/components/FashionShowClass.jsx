...
import { X, Facebook, Instagram, Crown, Sun, Snowflake, Building, Baby, Camera, Sparkles, Star, Phone } from 'lucide-react';

const FashionShowClass = () => {
  ...
  const fashionClasses = [
    {
      id: 1,
      name: "Kids Fashion Show",
      icon: <Baby className="w-6 h-6" />,
      description: "Glamorous runway training and fashion shows for young models"
    },
    {
      id: 2,
      name: "Summer Camp",
      icon: <Sun className="w-6 h-6" />,
      description: "Exciting summer fashion workshops and modeling activities"
    },
    {
      id: 3,
      name: "Winter Camp",
      icon: <Snowflake className="w-6 h-6" />,
      description: "Winter-themed fashion shows and cozy modeling sessions"
    },
    {
      id: 4,
      name: "Government Events",
      icon: <Building className="w-6 h-6" />,
      description: "Professional fashion shows for official government functions and events"
    }
  ];
  ...
  const openClassDetails = (fashionClass) => {
    setSelectedClass(fashionClass);
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 lg:mb-12">
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold mb-4">
            <span className="text-gray-900">Fashion Show </span>
            <span className="bg-gradient-to-r from-pink-600 via-rose-600 to-pink-700 bg-clip-text text-transparent">Classes</span>
          </h1>
          <div className="w-24 h-1 bg-gradient-to-r from-pink-600 to-rose-600 mx-auto mb-4"></div>
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
            Step into the spotlight with our professional fashion show training programs
          </p>
        </div>

        {/* Fashion Class Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
          {fashionClasses.map((fashionClass) => (
            <div
              key={fashionClass.id}
              ...
              onClick={() => openClassDetails(fashionClass)}
            >
              {/* Icon Display */}
              <div className="relative overflow-hidden aspect-[4/3] bg-gradient-to-br from-pink-100 to-rose-100 flex items-center justify-center">
                <div className="transform group-hover:scale-110 transition-transform duration-300">
                  <div className="w-20 h-20 bg-gradient-to-r from-pink-600 to-rose-600 rounded-full flex items-center justify-center text-white shadow-lg">
                    {fashionClass.icon}
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex space-x-1">
                    {[...Array(5)].map((_, i) => (
                      <div
                        key={i}
                        className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-gradient-to-r from-pink-600 to-rose-600 rounded-full"
                      />
                    ))}
                  </div>
                </div>
            ...
            <div className="relative max-w-2xl w-full bg-white rounded-2xl shadow-2xl">
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="text-center mb-6">
                  <div className="w-24 h-24 bg-gradient-to-r from-pink-600 to-rose-600 rounded-full flex items-center justify-center text-white shadow-lg mx-auto mb-4">
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600">
                    Ready to start your fashion journey? Get in touch with us!
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="fashion-modal-name" className="block text-sm font-medium text-gray-700 mb-2">
                        Full Name <span className="text-red-500">*</span>
                      </label>
                      <input
                        type="text"
                        id="fashion-modal-name"
                        name="name"
                    ...
                    <div>
                      <label htmlFor="fashion-modal-email" className="block text-sm font-medium text-gray-700 mb-2">
                        Email Address <span className="text-red-500">*</span>
                      </label>
                      <input
                        type="email"
                        id="fashion-modal-email"
                        name="email"
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="fashion-modal-phone" className="block text-sm font-medium text-gray-700 mb-2">
                        Phone Number
                      </label>
                      <input
                        type="tel"
                        id="fashion-modal-phone"
                        name="phone"
                    ...
                    <div>
                      <label htmlFor="fashion-modal-subject" className="block text-sm font-medium text-gray-700 mb-2">
                        Subject
                      </label>
                      <select
                        id="fashion-modal-subject"
                        name="subject"
                      ...
                      >
                        ...
                        <option value="Kids Fashion Show">Kids Fashion Show</option>
                  ...
                  <div>
                    <label htmlFor="fashion-modal-message" className="block text-sm font-medium text-gray-700 mb-2">
                      Message <span className="text-red-500">*</span>
                    </label>
                    <textarea
                      id="fashion-modal-message"
                      name="message"
                      ...
                      placeholder="Tell us about your interest in our fashion programs..."
                    ></textarea>
                  </div>
...
export default FashionShowClass;